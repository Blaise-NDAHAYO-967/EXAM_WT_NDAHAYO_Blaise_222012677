...
if (isset($_REQUEST['guide_id'])) {
    $g_id = $_REQUEST['guide_id'];
    
    // Prepare and execute the DELETE statement
    $stmt = $connection->prepare("DELETE FROM careguides WHERE guide_id=?");
    ...
    <body>
        <div class="container">
            ...
            <form method="post" onsubmit="return confirmDelete();">
                <input type="hidden" name="g_id" value="<?php echo htmlspecialchars($g_id); ?>">
