...
if (isset($_REQUEST['issue_id'])) {
    ...
    $stmt = $connection->prepare("DELETE FROM plantissues WHERE issue_id=?");
    ...
    <body>
        <div class="container">
            ...
            <form method="post" onsubmit="return confirmDelete();">
                <input type="hidden" name="iss_id" value="<?php echo htmlspecialchars($iss_id); ?>">
