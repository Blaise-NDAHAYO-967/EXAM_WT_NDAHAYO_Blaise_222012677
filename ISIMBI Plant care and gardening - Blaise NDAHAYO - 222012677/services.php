...
<section>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['insert'])) {
        $stmt = $connection->prepare("INSERT INTO services (service_id, name, description,price) VALUES (?, ?, ?,?)");
        $stmt->bind_param("isss", $s_id, $n,$d,$p);
            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                   ...
                   <td>{$row["name"]}</td>
                    ...
                    <td><a href='delete_services.php?service_id={$row["service_id"]}'>Delete</a></td> 
                    <td><a href='update_services.php?service_id={$row["service_id"]}'>Update</a></td> 
                </tr>";
            }
        } else {
